...
var TweenLite = __commonjs(function (module, exports, global) {
/*!
 * VERSION: 1.18.2
 * DATE: 2015-12-22
...
})((typeof(module) !== "undefined" && module.exports && typeof(global) !== "undefined") ? global : __commonjs_global || window, "TweenLite");
});

var TweenLite$1 = (TweenLite && typeof TweenLite === 'object' && 'default' in TweenLite ? TweenLite['default'] : TweenLite);

var CSSPlugin = __commonjs(function (module, exports, global) {
/*!
 * VERSION: 1.18.2
 * DATE: 2015-12-22
 * UPDATES AND DOCS AT: http://greensock.com
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope = (typeof(module) !== "undefined" && module.exports && typeof(global) !== "undefined") ? global : __commonjs_global || window; //helps ensure compatibility with AMD/RequireJS and CommonJS/Node
...
var Draggable = __commonjs(function (module, exports, global) {
/*!
 * VERSION: 0.14.3
 * DATE: 2015-12-19
 * UPDATES AND DOCS AT: http://greensock.com
...
var Draggable$1 = (Draggable && typeof Draggable === 'object' && 'default' in Draggable ? Draggable['default'] : Draggable);

function touchInit() {
	var grid = function grid(d) {
		return TweenLite$1.set($('#emoji__grid'), { y: d !== false ? 0 : document.body.clientHeight });
	};

	var options = function options(d) {
		return TweenLite$1.set($('#emoji__options'), { x: d !== false ? 0 : document.body.clientWidth });
	};
	...
	$('#emoji__options').on('click', function (e) {
		e.stopPropagation();
		$$('.custom-ul-select').forEach(function (el) {
			return el.fire('close');
		});
	});
	$('#emoji__grid').on('click', function (e) {
...
Promise.all([addScript('https://cdn.rawgit.com/AdaRoseEdwards/dirty-dom/v1.2.2/build/dirty-dom-lib.min.js').promise, addScript('https://twemoji.maxcdn.com/2/twemoji.min.js').promise]).then(function () {
	...
	try {
		for (var _iterator = skinTone[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			var s = _step.value;

			var selected = s === getItem('skinTone');
	...
	skinToneSelector.on('change', function (e) {
		var modifier = e.detail.value;
		setItem('skinTone', modifier);
		$$('.emoji__grid-item').forEach(function (el) {
	...
	mainGrid.$$('.emoji__grid-item').map(function (item, i) {
